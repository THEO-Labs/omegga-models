"""Stage 5 — Masking (egg cutout, U-Net + MobileNetV3-small).

UTILITY stage — no verdict, just produces a binary mask consumed by
Pose (Stage 6) or any future mask-aware classifier.
